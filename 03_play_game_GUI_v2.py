...
class Play:
    ...
    # randomly choose six colours from buttons
    def get_rounds_colors(self):
        round_colour_list = []
        color_scores = []
    ...
    def new_round(self):
        ...
        self.button_colours_list = self.get_rounds_colors()
