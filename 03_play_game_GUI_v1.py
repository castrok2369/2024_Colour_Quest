...
class Play:
    ...
    def __init__(self, how_many):
        ...
        # initially sset rounds played and rounds won to 0
        ...
        instruction = "Choose one of the colours below. When you choose " \
                      "a colour, the computer's choice and the results " \
                      "the round will be revealed."
        self.instructions_label = Label(self.quest_frame, text=instruction,
                                        wraplength=350, justify="left")
        self.instructions_label.grid(row=1)

        # get colours for buttons for first round...
        button_colours_list = self.get_round_colors()
        print("colour list", button_colours_list)  # for testing purposes only remove
        ...
        self.game_results_label = Label(self.quest_frame,
                                        text="Games Totals: User: - \t Computer: -",
    ...
    def get_all_colours(self):
        ...
        # remove first entry in list (ie: the header row).
        var_all_colors.pop()
    ...
    def to_compare(self, user_score):
        ...
        # detects which 'controls' button was pressed and
    ...
    # don't use this function in the base as it kills the root
    def close_play(self):
        root.destroy()
